...
class ising:
	...
	def UpdateSensors(self):
		self.speed_ind_leg1_j0 = self.SensorIndex(self.env.joints[0].speed/self.env.vmaxhip , self.env.vmaxhip) 
		self.sensors[0:4] = 2 * bitfield(self.speed_ind_leg1_j0, int(self.Ssize/5)) - 1
		self.speed_ind_leg1_j1 = self.SensorIndex(self.env.joints[1].speed/self.env.vmaxknee , self.env.vmaxknee)
		self.sensors[4:8] = 2 * bitfield(self.speed_ind_leg1_j1, int(self.Ssize/5)) - 1
		self.speed_ind_leg2_j0 = self.SensorIndex(self.env.joints[2].speed/self.env.vmaxhip , self.env.vmaxhip)
		self.sensors[8:12] = 2 * bitfield(self.speed_ind_leg2_j0, int(self.Ssize/5)) - 1
		self.speed_ind_leg2_j1 = self.SensorIndex(self.env.joints[3].speed/self.env.vmaxknee , self.env.vmaxknee)
		self.sensors[12:16] = 2 * bitfield(self.speed_ind_leg2_j1, int(self.Ssize/5)) - 1
		self.hull_height = self.SensorIndex(self.env.hull.position[1] , 20)
		self.sensors[16:] = 2 * bitfield(self.hull_height, int(self.Ssize/5)) - 1

		print(self.env.hull.position[1])
